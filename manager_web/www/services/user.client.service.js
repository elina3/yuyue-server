  ...
  ['Auth', 'RequestSupport', 'SystemError',
    function (Auth, RequestSupport, SystemError) {
      return {
        ...
        stopDoctorSchedule: function(param, callback){
          RequestSupport.executePost('/user/doctor/stop_appointment', param)
          .then(function (data) {
                if (!callback) {
                  return data;
                } else {
        ...
        batchImportSchedules: function(param, callback){
          RequestSupport.executePost('/user/doctor/batch_add_schedule', param)
          .then(function (data) {
                if (!callback) {
                  return data;
                } else {
